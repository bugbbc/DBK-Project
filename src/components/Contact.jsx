...
const contactInfo = [
  {
    ...
    title: "学院网址",
    content: "https://ai.nuaa.edu.cn/",
    href: "https://ai.nuaa.edu.cn/",
  },
  {
    icon: <FaPhone size={22} />,
    title: "联系电话",
    content: "021-521166382",
    href: "tel:021-521166382",
  },
  {
    icon: <FaMapMarkerAlt size={22} />,
    title: "办公地址",
    content: "中国江苏省南京市江宁区南京航空航天大学人工智能学院",
    href: "#",
  },
];
      ...
      <div className="grid lg:grid-cols-2 gap-12 mt-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {isSubmitting ? (
                  ...
                  <>
                    <FaPaperPlane className="mr-2" /> 立即发送
                  </>
                )}
              </button>
            </form>
        ...
        <div className="space-y-8">
          ...
          {contactInfo.map((info, index) => (
            <div
              key={index}
              className="module-card p-5 flex items-start space-x-5"
            >
              <div className="flex-shrink-0 mt-1 text-brand-primary">
                {info.icon}
              </div>
              <div>
